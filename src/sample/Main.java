...
import sample.controllers.ShowNoteController;
...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception{
        ...
        FXMLLoader loader;
        try {
            loader = new FXMLLoader(getClass().getResource("/sample/scenes/sample.fxml"));
            root = loader.load();
    ...
    public static ObservableList<Note> loadNotes() {
        ...
        while(scanner.hasNextLine()){
            ...
            note = new Note(strings[1],text,strings[3], id);
            notes.add(note);
        }
        return notes;
    }
